...
public class Hsg73pfId implements Serializable {
    ...
    public Hsg73pfId(String pakz, String rechNr, String rechDatum, String auftragsNr, String bereich, String claimNr, String fehlerNr) {
        this.pakz = pakz;
        this.rechNr = rechNr;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Hsg73pfId)) return false;
        Hsg73pfId that = (Hsg73pfId) o;
